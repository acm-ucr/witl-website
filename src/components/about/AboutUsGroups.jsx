...
const AboutUsGroups = () => {
  ...
  return (
    <div className="relative w-[100%] aspect-[4/3] mt-[-100px]">
      ...
      <div
        ref={im1}
        className="absolute w-[30%] lg:w-[20%] aspect-[3/5] top-[15%] left-[-0%]"
        onClick={prevSlide}
      >
        <Image src={aboutItems[leftInd]} alt="group pic" />
      </div>
      <div
        ref={im2}
        className="absolute w-[30%] lg:w-[20%] aspect-[3/5] left-[50%] mx-[-15%] lg:mx-[-10%] lg:mt-[1%]"
      >
        <Image src={aboutItems[currInd]} alt="group pic" />
      </div>
      <div
        ref={im3}
        className="absolute w-[30%] lg:w-[20%] aspect-[3/5] top-[15%] right-[-0%]"
        onClick={nextSlide}
      >
        <Image src={aboutItems[rightInd]} alt="group pic" />
      </div>
      <div className="absolute w-[30%] lg:w-[20%] aspect-[3/5] left-[50%] transform -translate-x-1/2 ">
        <div className="relative w-[50%] lg:w-[20%] -bottom-[100%] left-[45%] md:left-[55%] lg:left-[65%] -mx-[25%] mt-[-10%] lg:mt-[0%] grid grid-cols-3">

const Sponsors = () => {
  return (
    <div className="relative bg-witl-purple-300 mt-[50%] w-[100%]">
      ...
      <div className="absolute top-[10%] right-[0%] bg-witl-purple-400 text-witl-white-100 font-libre-caslon-text font-bold text-[49.37px] w-[55%]">
        <div className="pl-[3%] text-sm lg:text-4xl md:text-2xl">
          BLUEPRINT TEST PREP
        </div>
      </div>
      <div className="flex flex-col bg-witl-purple-300 text-[49.37px] text-white font-bold">
        <div className="w-1/2 bg-witl-purple-400 mb-6 mt-4 font-libre-caslon-text text-right pr-5 text-sm lg:text-4xl md:text-2xl">
          BEST BEST KRIEGER
        </div>
        <div className="flex justify-end">
          <div className="w-1/3 bg-witl-purple-400 font-libre-caslon-text pl-[2%] text-left text-sm lg:text-4xl md:text-2xl">
            HQR INC.
          </div>
        </div>
